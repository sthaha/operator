...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RegistryExtension) DeepCopyInto(out *RegistryExtension) {
	*out = *in
	if in.Override != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RegistryExtension.
func (in *RegistryExtension) DeepCopy() *RegistryExtension {
	if in == nil {
		return nil
	}
	out := new(RegistryExtension)
